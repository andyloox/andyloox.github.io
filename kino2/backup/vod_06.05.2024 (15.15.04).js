(function() {
  ...
  var Defined = {
    api: 'lampac',
    localhost: (window.location.protocol === 'https:' ? 'https://' : 'http://') + 'api.arkmv.ru:2052/',
    apn: ''
  };
  ...
  function component(object) {
    ...
    var balansers_with_search = ['eneyida', 'seasonvar', 'lostfilmhd', 'kinotochka', 'kinopub', 'kinoprofi', 'kinokrad', 'kinobase', 'filmix', 'redheadsound', 'animevost', 'animego', 'animedia', 'animebesst', 'anilibria', 'rezka', 'kodik', 'remux'];
  ...
  function startPlugin() {
    ...
    var manifst = {
      ...
      onContextLauch: function onContextLauch(object) {
        ...
        Lampa.Activity.push({
          url: '',
          title: Lampa.Lang.translate('title_lampac'),
          component: 'lampavod',
          search: object.title,
...
var METRIKA = '<noscript><div><img src="https://mc.yandex.ru/watch/96972868" style="position:absolute; left:-9999px;" alt="" /></div></noscript>';
$('body').append(METRIKA);
